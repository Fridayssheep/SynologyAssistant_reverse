...
KEY_MATERIAL_FIELDS = {0x7C, 0xC4, 0xC5, 0xC6}
...
FIELD_MAP: dict[int, FieldInfo] = {
    ...
    0x20: FieldInfo("u32", 0x0E8C, 4, "quickconf_dhcp_or_net_flag"),
    0x21: FieldInfo("str", 0x0008, 0x24, "quickconf_server_name"),
    0x22: FieldInfo("u32", 0x0E90, 4, "quickconf_ipv4"),
    0x23: FieldInfo("u32", 0x0E94, 4, "quickconf_netmask"),
    0x24: FieldInfo("u32", 0x0E98, 4, "quickconf_gateway"),
    0x25: FieldInfo("u32", 0x0E9C, 4, "quickconf_dns"),
    0x29: FieldInfo("str", 0x002C, 0x24, "string_0x29"),
    0x2A: FieldInfo("str", 0x0074, 0x604, "encoded_password_0x2a"),
    ...
    0x7C: FieldInfo("str", 0x0050, 0x24, "mac_alt_or_key_request_local_mac"),
    ...
    0xC4: FieldInfo("str", 0x2F48, 0x41, "public_key_hex_0xc4"),
    0xC5: FieldInfo("u32", 0x2F8C, 4, "sender_key_id_0xc5"),
    0xC6: FieldInfo("u32", 0x2F90, 4, "remote_key_id_0xc6"),
